...
import type { IconComponent } from "@/chat-ui/lib/icon-context";
import { cn } from "@/chat-ui/lib/utils";
import { useShape } from "@/chat-ui/lib/shape-context";

const buttonVariants = cva(
  [
    "group relative isolate inline-flex items-center justify-center outline-none cursor-pointer border-0",
...
interface ButtonProps
  ...
  /** Force the visual pressed/held state. */
  active?: boolean;
}
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // structure (bg layer, content wrapper, spinner, icons) must survive.
